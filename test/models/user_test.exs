defmodule Chatter.UserTest do
  ...
  @valid_attrs %{email: "steve@example.com", password: "abcde12345", password_confirmation: "abcde12345"}
  @invalid_attrs %{email: "stevexample.com", password: "abcd", password_confirmation: "abcd"}
